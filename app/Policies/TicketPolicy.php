...
class TicketPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Ticket $ticket = null)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Ticket $ticket = null)
    {
        return $user->can('Delete ticket');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Ticket $ticket = null)
    {
        return $user->can('Delete ticket');
    }
}
